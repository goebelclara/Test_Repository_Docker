...
#  Default: '/opt/app/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/opt/app/.jupyter/lab/user-settings'
...
#  Default: '/opt/app/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/opt/app/.jupyter/lab/workspaces'
